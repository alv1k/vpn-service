...
def test_sub_url_empty_is_json_encoded(mock_get_user, mock_keys, client):
...
@patch("api.web_portal.get_user_by_web_token")
def test_sub_url_with_value_is_json_string(mock_get_user, mock_keys, client):
...
@patch("api.web_portal.get_keys_by_tg_id")
@patch("api.web_portal.get_user_by_web_token")
def test_sub_url_injection_is_prevented(mock_get_user, mock_keys, client):
